...
import 'package:agriplant/widgets/services_slider.dart';
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Services section (replacing Promotions)
          buildSectionHeader(
            context,
            'Our Services',
            'View all',
            ...
            showDivider: true,
            onViewAllPressed: () {
              // Navigate to services page (index 2 in bottom navigation)
              Navigator.of(context)
                  .pushNamedAndRemoveUntil('/', (route) => false);
              // The actual navigation will need to be implemented in the HomePage
            },
          ),
          const SizedBox(height: 12),
          buildServicesSlider(services, context),
          const SizedBox(height: 24),
