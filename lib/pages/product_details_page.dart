...
import 'package:agriplant/models/product.dart' show Product, CartItem;
import 'package:agriplant/provider/cart_provider.dart' show CartProvider;
...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  void _addToCart() {
    // Create a cart item using the CartItem from models/product.dart
  ...
  Widget build(BuildContext context) {
    ...
    final cartItemCount =
        cartProvider.totalQuantity; // Use totalQuantity instead of items.length
